...
const SNAPSHOT_GENERATED_AT = '2025-03-28T14:30:00.000Z';
...
function buildFinancialIntelligenceSnapshot(): FinancialIntelligenceSnapshot {
...
const financialIntelligenceSnapshot: FinancialIntelligenceSnapshot = buildFinancialIntelligenceSnapshot();

Object.freeze(financialIntelligenceSnapshot.metrics);
financialIntelligenceSnapshot.growth.trailingMonths.forEach(Object.freeze);
Object.freeze(financialIntelligenceSnapshot.growth.trailingMonths);
Object.freeze(financialIntelligenceSnapshot.growth);
financialIntelligenceSnapshot.risk.riskIndicators.forEach(Object.freeze);
Object.freeze(financialIntelligenceSnapshot.risk.riskIndicators);
Object.freeze(financialIntelligenceSnapshot.risk);
financialIntelligenceSnapshot.insights.forEach(Object.freeze);
Object.freeze(financialIntelligenceSnapshot.insights);
Object.freeze(financialIntelligenceSnapshot);

export function getFinancialIntelligenceSnapshot(): FinancialIntelligenceSnapshot {
  return financialIntelligenceSnapshot;
}

export const financialIntelligence = financialIntelligenceSnapshot;
